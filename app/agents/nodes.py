...
def router(state: dict) -> dict:
    ...
    system = (
        ...
        f"{state['schema']}.\n"
        "Учитывай ВЕСЬ диалог ниже (включая твои прошлые уточнения и ответы пользователя).\n"
...
def clarifier(state: dict) -> dict:
    ...
    system = (
        ...
        f"{state['schema']}.\n"
        "Учитывай весь диалог ниже. Задай ОДИН короткий уточняющий вопрос на русском, "
...
def sql_agent(state: dict) -> dict:
    ...
    system = (
        ...
        "Учитывай весь диалог ниже (вопрос пользователя и уточнения).\n"
